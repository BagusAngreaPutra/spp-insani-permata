...
<div class="main-content">
    ...
    <div class="content-area">
        ...
        @include('partials.admin-page-context', [
            ...
            'title' => 'Tahun ajaran mengikat kelas dan siswa pada periode aktif.',
            'description' => 'Buat tahun ajaran terlebih dahulu agar data siswa dan kelas punya konteks periode yang jelas.',
            'steps' => ['Tahun Ajaran', 'Kelas', 'Siswa']
        ])
                ...
                <tbody>
                    @forelse ($tahunAjaran as $item)
                        <tr>
                            ...
                            <td class="flex gap-2">
                                <a href="{{ route('tahun_ajaran.edit', $item->id) }}" class="btn-edit">Edit</a>
                                <form action="{{ route('tahun_ajaran.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Hapus data ini?')" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
