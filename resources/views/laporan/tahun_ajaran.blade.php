...
<div id="pi-report-page" class="main-content pi-report-page">
    ...
    <div class="content-area pi-report-document">
        ...
        <h3 class="print-title d-none d-print-block">LAPORAN DATA TAHUN AJARAN</h3>

        <div class="page-header no-print">
            <h2 class="page-title">
                <i class="fas fa-calendar-alt"></i> Laporan Data Tahun Ajaran
            </h2>
            <div>
                <a href="{{ route('laporan.tahun_ajaran.excel') }}" class="btn-primary">
