...
<div class="main-content">
    ...
    <div class="content-area">
        <div class="page-header">
            <h1><i class="fas fa-list"></i> Detail Log Aktivitas</h1>
        </div>

        <div class="report-list">
            <table>
                <tr><th>ID Log</th><td>{{ $log->id }}</td></tr>
                <tr><th>Aktor</th><td>{{ $namaAktor }} ({{ $log->aktor_type }})</td></tr>
                <tr><th>Aktivitas</th><td>{{ $log->aktivitas }}</td></tr>
                <tr><th>IP Address</th><td>{{ $log->ip_address }}</td></tr>
                <tr><th>User Agent</th><td>{{ $log->user_agent }}</td></tr>
                <tr><th>Dibuat Pada</th><td>{{ $log->created_at->format('d-m-Y H:i:s') }}</td></tr>
            </table>
        </div>

        <div class="action-card">
            <a href="{{ route('log_aktivitas.index') }}" class="btn btn-secondary">
