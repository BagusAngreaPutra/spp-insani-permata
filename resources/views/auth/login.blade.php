...
<head>
    ...
    <title>Login Admin - SPP SD IT Permata Insani</title>
...
<body>
    ...
    <div class="login-container">
        <div class="login-header">
            ...
            <p class="login-subtitle">Masuk untuk mengelola sistem SPP sekolah</p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" id="loginForm">
            ...
            <div class="form-group">
                ...
                <input id="username" type="text" name="username"
                       class="form-input" placeholder="Masukkan username admin"
