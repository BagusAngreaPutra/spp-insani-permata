        ...
        <div class="form-container">
            ...
            <form action="{{ route('jenis_pembayaran.store') }}" method="POST">
                ...
                <select name="tipe" class="form-control" required>
                    ...
                    <option value="sekali" {{ old('tipe') == 'sekali' ? 'selected' : '' }}>Sekali</option>
                    <option value="bulanan" {{ old('tipe') == 'bulanan' ? 'selected' : '' }}>Bulanan</option>
                    <option value="setahun" {{ old('tipe') == 'setahun' ? 'selected' : '' }}>Setahun</option>
                </select>
...
function toggleVisibleStudents() {
    const visibleCheckboxes = document.querySelectorAll('#students-list input[type="checkbox"]:not([style*="display: none"])');
