        ...
        <div class="form-container">
            ...
            <form action="{{ route('jenis_pembayaran.update', $jenis->id) }}" method="POST">
                ...
                <select name="tipe" class="form-control" required>
                    <option value="sekali" {{ old('tipe', $jenis->tipe) == 'sekali' ? 'selected' : '' }}>Sekali Bayar</option>
                    <option value="bulanan" {{ old('tipe', $jenis->tipe) == 'bulanan' ? 'selected' : '' }}>Bulanan (12x setahun)</option>
                    <option value="setahun" {{ old('tipe', $jenis->tipe) == 'setahun' ? 'selected' : '' }}>Tahunan</option>
                    <option value="semester" {{ old('tipe', $jenis->tipe) == 'semester' ? 'selected' : '' }}>Per Semester (2x setahun)</option>
                </select>
                ...
                <div id="field-jatuh-tempo-semester" class="jt-field" style="display:none;">
                    ...
                    <select name="jatuh_tempo" class="form-control" disabled>
                        ...
                        <option value="1" {{ $jenis->tipe == 'semester' && $jenis->jatuh_tempo == '1' ? 'selected' : '' }}>Januari & Juli</option>
                        <option value="2" {{ $jenis->tipe == 'semester' && $jenis->jatuh_tempo == '2' ? 'selected' : '' }}>Februari & Agustus</option>
                        <option value="3" {{ $jenis->tipe == 'semester' && $jenis->jatuh_tempo == '3' ? 'selected' : '' }}>Maret & September</option>
                        <option value="4" {{ $jenis->tipe == 'semester' && $jenis->jatuh_tempo == '4' ? 'selected' : '' }}>April & Oktober</option>
                        <option value="5" {{ $jenis->tipe == 'semester' && $jenis->jatuh_tempo == '5' ? 'selected' : '' }}>Mei & November</option>
                        <option value="6" {{ $jenis->tipe == 'semester' && $jenis->jatuh_tempo == '6' ? 'selected' : '' }}>Juni & Desember</option>
                    </select>
                </div>
