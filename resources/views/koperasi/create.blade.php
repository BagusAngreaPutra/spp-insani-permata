...
<div class="main-content">
    ...
    <div class="content-area">
        @include('partials.admin-page-context', [
            ...
            'title' => 'Tambahkan barang yang dijual koperasi.',
            'description' => 'Barang koperasi tidak masuk ke jenis pembayaran sekolah, sehingga data SPP dan biaya wajib tetap bersih.'
        ])

        <div class="form-card">
            <h2 class="page-title"><i class="fas fa-plus"></i> Tambah Barang Koperasi</h2>
