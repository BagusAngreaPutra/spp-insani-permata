    ...
    <nav class="app-sidebar" id="appSidebar">
        ...
        <div class="app-sidebar-menu">
            ...
            <div class="app-menu-item">
                ...
                class="app-menu-link {{ request()->routeIs('siswa.tagihan-saya') ? 'app-active' : '' }}">
                    <div class="app-menu-icon">
                        <i class="fas fa-money-check-alt"></i>
                    </div>
                    <span class="app-menu-text">Tagihan Saya</span>
                </a>
            </div>
            ...
            <div class="app-menu-item">
                <a href="{{ route('siswa.riwayat.index') }}"
                   class="app-menu-link {{ request()->routeIs('siswa.riwayat.*') ? 'app-active' : '' }}">
                    <div class="app-menu-icon">
                        <i class="fas fa-history"></i>
                    </div>
                    <span class="app-menu-text">Riwayat Pembayaran</span>
                </a>
            </div>
            ...
            <div class="app-menu-item">
                <a href="{{ route('siswa.profil.index') }}"
                   class="app-menu-link {{ request()->routeIs('siswa.profile') ? 'app-active' : '' }}">
                    <div class="app-menu-icon">
                        <i class="fas fa-user"></i>
                    </div>
                    <span class="app-menu-text">Profil Saya</span>
                </a>
            </div>
            ...
            <div class="app-menu-item">
                <form method="POST" action="{{ route('siswa.logout') }}">
                    @csrf
                    <button type="submit" class="app-menu-link" style="width:100%;text-align:left;border:none;background:none;">
                        <div class="app-menu-icon">
                            <i class="fas fa-sign-out-alt"></i>
                        </div>
                        <span class="app-menu-text">Logout</span>
                    </button>
                </form>
            </div>
        </div>
